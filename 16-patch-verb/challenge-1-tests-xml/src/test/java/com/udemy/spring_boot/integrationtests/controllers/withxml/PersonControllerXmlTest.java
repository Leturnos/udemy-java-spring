package com.udemy.spring_boot.integrationtests.controllers.withxml;
...
class PersonControllerXmlTest extends AbstractIntegrationTest {
    ...
    void createTest() throws JsonProcessingException {
        ...
        var bodyContent = given(specification)
            .contentType(MediaType.APPLICATION_XML_VALUE) // request
                .body(person)
            .when()
                .post()
            .then()
                .statusCode(200)
                .contentType(MediaType.APPLICATION_XML_VALUE) // response
            .extract()
                .body()
                    .asString();

        PersonDTO createdPerson = xmlMapper.readValue(bodyContent, PersonDTO.class);
    ...
    void findAllTest() throws JsonProcessingException {
        ...
        List<PersonDTO> people = xmlMapper.readValue(bodyContent, new TypeReference<List<PersonDTO>>() {});
