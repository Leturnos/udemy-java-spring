...
import com.udemy.spring_boot.integrationtests.dto.Wrapper.json.BookHalPagedModel;
...
class BookControllerJsonTest extends AbstractIntegrationTest {
    ...
    void createTest() throws JsonProcessingException, ParseException {
        ...
        BookDTO createdBook = objectMapper.readValue(bodyContent, BookDTO.class);
        bookDTO = createdBook;
    ...
    void findAllTest() throws JsonProcessingException {
        ...
        BookHalPagedModel wrapper = objectMapper.readValue(bodyContent, BookHalPagedModel.class);
        List<BookDTO> book = wrapper.getEmbeddedDTO().getBook();
